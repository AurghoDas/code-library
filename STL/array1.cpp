...
2. Contiguous storage:- The elements are stored in contiguous memory locations.

3. Fixed-size aggregate:- The container uses implicit constructors and destructors to allocate the required space.
